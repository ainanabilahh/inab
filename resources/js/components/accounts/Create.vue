<template>
    ...
    <form class="space-y-6" @submit.prevent="saveAccount">
        ...
        <div>
            ...
            <div class="mt-1">
                <select v-model="form.category" id="category_id" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
